					...
					<div id="footer" class="container text-center">
						...
						<div class="row">    
							...
							<div class="col-md-4 col-sm-12" id="footer-logo">
								...
								<p class="mb-0">Wise1 AI is a cutting-edge content creation platform that uses advanced AI technology, multilingual support, and expert templates to make content creation effortless for students, entrepreneurs, farmers, educators, and more. Join the revolution today and see the difference for yourself.</p>		
...
<?php endif; ?><?php /**PATH /home/wisesqsn/public_html/resources/views/layouts/frontend.blade.php ENDPATH**/ ?>