                ...
                <div class="container">
                    ...
                    <div class="row text-center mt-8 mb-8">
                        <div class="col-md-12 title">
                            ...
                            <p><?php echo e(__('Enjoy the full flexibility of the platform with tons of features')); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="row d-flex" id="solutions-list">
                            ...
                            <div class="col-sm-12 mb-6">
                                ...
                                <div class="solution" data-aos="zoom-in" data-aos-delay="1000" data-aos-once="true" data-aos-duration="1000">                                                                          
                                    ...
                                    <div class="solution-content">
                                        ...
                                        <p>Get Ahead of the Game: Harness the power of cutting-edge AI technology to create unbeatable content that stands out from the crowd.</p>
                            ...
                            <div class="col-sm-12 mb-6">
                                ...
                                <div class="solution" data-aos="zoom-in" data-aos-delay="1500" data-aos-once="true" data-aos-duration="1500">
                                    ...
                                    <div class="solution-content">
                                        ...
                                        <p>Take Your Content Global: With support for over 25 languages, create content that connects with audiences worldwide</p>
                            ...
                            <div class="col-sm-12 mb-6">
                                ...
                                <div class="solution" data-aos="zoom-in" data-aos-delay="2000" data-aos-once="true" data-aos-duration="2000">
                                    ...
                                    <div class="solution-content">
                                        ...
                                        <p>Ironclad Security: Keep your account safe and secure with two-factor authentication, so you can have peace of mind knowing your data is always protected.</p>
                            ...
                            <div class="col-sm-12 mb-6">
                                ...
                                <div class="solution" data-aos="zoom-in" data-aos-delay="1000" data-aos-once="true" data-aos-duration="1000">
                                    ...
                                    <div class="solution-content">
                                        ...
                                        <p>Effortlessly Craft Unique Content: Easily customize and fine-tune AI-generated text to create compelling content that resonates with your audience.</p>
                            ...
                            <div class="col-sm-12 mb-6">
                                ...
                                <div class="solution" data-aos="zoom-in" data-aos-delay="1500" data-aos-once="true" data-aos-duration="1500">
                                    ...
                                    <div class="solution-content">
                                        ...
                                        <p>Effortless Export: Style and Export your AI-generated text results in PDF, Word or TXT format in just a few clicks, so you can focus on what really matters.</p>
                            ...
                            <div class="col-sm-12 mb-6">
                                ...
                                <div class="solution" data-aos="zoom-in" data-aos-delay="2000" data-aos-once="true" data-aos-duration="2000">
                                    ...
                                    <div class="solution-content">
                                        ...
                                        <p>Elevate Your Content: Create stunning, professional-grade images using AI technology to bring your content to life.</p>
                        ...
                        <div class="col-md-4 col-sm-12 d-flex">
                            ...
                            <div class="feature-text">
                                ...
                                <p>Welcome to Wise 1 AI, the ultimate platform for hassle-free content creation. With cutting-edge AI technology at your fingertips, you can create anything from business plans to SEO content to resumes in just seconds. We understand the unique challenges faced by students, entrepreneurs, farmers, and educators alike, which is why we offer templates specifically tailored to your niche. </p>
                                <p>Our templates are specifically designed to help you solve the most pressing issues in your field. Whether you're a student struggling with a research paper, an entrepreneur in need of a business plan, or an educator looking for new lesson ideas, our templates have got you covered. Each template is carefully crafted by experts in your niche, using the latest in AI technology to ensure maximum effectiveness. With Wise 1 AI, you can create high-quality, professional-grade content in seconds, all without sacrificing quality or creativity. Join the revolution today and see the difference for yourself.</p>
                                 <p>Our platform also boasts features like effortless text editing, multilingual support, stunning image generation, and ironclad security. Join the ranks of the wisest and most successful content creators around the world - join Wise 1 AI today.</p>
                            </div>
    ...
    <script type="text/javascript">
		$(function () {
            ...
            var typed = new Typed('#typed', {
                strings: ['<h1><span><?php echo e(__('Agriculture, entrepreneurship')); ?></span></h1>', 
                            '<h1><span><?php echo e(__('Business plan Generator')); ?></span></h1>', 
                            '<h1><span><?php echo e(__('Solutions to exam questions')); ?></span></h1>', 
                            '<h1><span><?php echo e(__('Article Generator')); ?></span></h1>', 
                            '<h1><span><?php echo e(__('Content Improver')); ?></span></h1>',
                            '<h1><span><?php echo e(__('Digital marketing, education')); ?></span></h1>',
...
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wisesqsn/public_html/resources/views/home.blade.php ENDPATH**/ ?>