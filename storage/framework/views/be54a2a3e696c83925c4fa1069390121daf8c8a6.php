        ...
        <div class="page-leftheader">
            ...
            <ol class="breadcrumb mb-2">
                <li class="breadcrumb-item"><a href="<?php echo e(route('user.dashboard')); ?>"><i
                            class="fa-solid fa-box-circle-check mr-2 fs-12"></i><?php echo e(__('User')); ?></a></li>
                <li class="breadcrumb-item active" aria-current="page"><a
                        href="<?php echo e(route('user.plans')); ?>"> <?php echo e(__('Pricing Plans')); ?></a></li>
                <li class="breadcrumb-item active" aria-current="page"><a
                        href="<?php echo e(url('#')); ?>"> <?php echo e(__('Subscription Plan Checkout')); ?></a></li>
            </ol>
        </div>
    </div>
    <!-- END PAGE HEADER -->
        ...
        <div class="col-xl-9 col-lg-12 col-md-12 col-sm-12">
            <div class="card border-0 pt-2">
                <div class="card-body">
                    ...
                    <form id="payment-form" action="<?php echo e(route('user.payments.pay', $id)); ?>" method="POST"
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-12 pr-4">
                                <div class="checkout-wrapper-box pb-0">
                                    ...
                                    <p class="checkout-title mt-2"><i
                                            class="fa-solid fa-lock-hashtag mr-2 text-success"></i><?php echo e(__('Secure Checkout')); ?>
                                    ...
                                    <div class="form-group" id="toggler">
                                                ...
                                                <div class="row w-100">
                                                    <?php $__currentLoopData = $payment_platforms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment_platform): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                                                            <label class="gateway btn rounded p-0"
                                                                   href="#<?php echo e($payment_platform->name); ?>Collapse"
                                                                   data-bs-toggle="collapse">
                                                                <input type="radio" class="gateway-radio"
                                        ...
                                        <?php $__currentLoopData = $payment_platforms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment_platform): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($payment_platform->name !== 'BankTransfer'): ?>
                                                <div id="<?php echo e($payment_platform->name); ?>Collapse" class="collapse"
                                            ...
                                            <?php else: ?>
                                                <div id="<?php echo e($payment_platform->name); ?>Collapse" class="collapse"
                                                    ...
                                                    <div class="text-center pb-2">
                                                        ...
                                                        <p class="text-muted fs-12 mb-4">Order ID: <span
                                                                class="font-weight-bold text-primary"><?php echo e($bank_order_id); ?></span>
                                                        </p>
                                                        <pre
                                                            class="text-muted fs-12 mb-4"><?php echo e($bank['bank_requisites']); ?></pre>
                                                    </div>
                                                </div>
                                            <?php endif; ?>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="col-md-6 col-sm-12 pl-4">
                                <div class="checkout-wrapper-box">
                                    ...
                                    <p class="checkout-title mt-2"><i
                                            class="fa fa-archive mr-2"></i><?php echo e(__('Plan Name')); ?>: <span
                                            class="text-info"><?php echo e($id->plan_name); ?> (<?php echo e(ucfirst($id->payment_frequency) . ' Plan'); ?>)</span>
                                    </p>
                                    ...
                                    <div>
                                        <p class="fs-12 p-family"><?php echo e(__('Subtotal')); ?> <span
                                                class="checkout-cost"><?php echo config('payment.default_system_currency_symbol'); ?><?php echo e(number_format((float)$id->price, 2, '.', '')); ?></span>
                                        </p>
                                        <p class="fs-12 p-family"><?php echo e(__('Taxes')); ?> <span class="text-muted">(<?php echo e(config('payment.payment_tax')); ?>%)</span><span
                                                class="checkout-cost"><?php echo config('payment.default_system_currency_symbol'); ?><?php echo e(number_format((float)$tax_value, 2, '.', '')); ?></span>
                                        </p>
                                    </div>
                                    ...
                                    <div>
                                        <p class="fs-12 p-family"><?php echo e(__('Total Payment')); ?> </span><span
                                                class="checkout-cost text-info"><?php echo config('payment.default_system_currency_symbol'); ?><span
                                                    id="total_payment"><?php echo e(number_format((float)$total_value, 2, '.', '')); ?></span> <?php echo e($currency); ?> <span
                                                    id="total_payment">≈ (<?php echo e(number_format((float)$convertedAmount, 0, '.', ' ')); ?></span> <?php echo e($devise); ?>)</span>
                                        </p>
                                    </div>
                    ...
                    >
                        ...
                        <input type="hidden" name="transaction_frequency"
                               value="<?php echo e(session()->get('cinet_pay_plan')); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wisesqsn/public_html/resources/views/user/plans/subscribe-checkout.blade.php ENDPATH**/ ?>