            ...
            <div class="card border-0 pt-2">
                <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-12 pl-4">
                                <div class="checkout-wrapper-box">
                                    ...
                                    <div>
                                        <p class="fs-12 p-family">{{ __('Total Payment') }} </span><span class="checkout-cost text-info">{!! config('payment.default_system_currency_symbol') !!}<span id="total_payment">{{ number_format((float)$total_value, 2, '.', '') }}</span> {{ $currency }} <span id="total_payment">≈ ({{ number_format((float)$convertedAmount, 0, '.', ' ') }}</span> {{ $devise }})</span></p>
                                    </div>
                    ...
                    >
                        ...
                        <input type="hidden" name="transaction_frequency" value="{{ session()->get('cinet_pay_plan') }}">
