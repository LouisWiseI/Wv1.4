                ...
                <div class="container">
                    ...
                    <div class="row text-center mt-8 mb-8">
                        <div class="col-md-12 title">
                            ...
                            <p>{{ __('Enjoy the full flexibility of the platform with tons of features') }}</p>
                        </div>
                    </div>
    ...
    <script type="text/javascript">
		$(function () {
            ...
            var typed = new Typed('#typed', {
                strings: ['<h1><span>{{ __('Agriculture, entrepreneurship') }}</span></h1>', 
                            '<h1><span>{{ __('Business plan Generator') }}</span></h1>', 
                            '<h1><span>{{ __('Solutions to exam questions') }}</span></h1>', 
                            '<h1><span>{{ __('Article Generator') }}</span></h1>', 
                            '<h1><span>{{ __('Content Improver') }}</span></h1>',
                            '<h1><span>{{ __('Digital marketing, education') }}</span></h1>',
