...
return [
    ...
    */
    ...
    //---CinetPay-- Add --02/04/23 ---Start   
     'cinetpay' => [
        'enable' => env('CINETPAY_ENABLED'),
        'subscription' => env('CINETPAY_SUBSCRIPTION'),
        'class' => App\Services\CinetPay::class,
        'site_id' => env('CINETPAY_SITEID'),
        'api_key' => env('CINETPAY_API_KEY'),
        'base_url' => env('CINETPAY_BASE_URL'),
        'secret_key' => env('CINETPAY_SECRET_KEY'),
        'payment_url' => env('CINETPAY_PAYMENT_URL'),
        'verify_url' => env('CINETPAY_VERIFY_URL'),
    ],
